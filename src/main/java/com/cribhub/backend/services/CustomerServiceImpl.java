...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Autowired
    public CustomerServiceImpl(CustomerRepository customerRepository, CribRepository cribRepository,
    ...
    public void deleteCustomer(Long id) throws CustomerNotFoundException {
        ...
        if (customerToDelete.getCrib() != null) {
            cribRepository.findById(customerToDelete.getCrib().getCribId())
                    .ifPresent(crib -> crib.getCribMembers().remove(customerToDelete));
        }
